        ...
        <div className="portfolio-heading" style={{color: 'white', textAlign: 'center', marginLeft: '1cm'}}>
          ...
          >
            ...
            <div className="portfolio-description">
              <h6 style={{fontStyle: 'italic', fontSize: '50px', fontWeight: 'bold'}} >Desktop Application</h6>
          ...
          >
            <div className="portfolio-description has-margin-right" style={{marginLeft: 20}}>
              <h6 style={{fontStyle: 'italic', fontSize: '50px', fontWeight: 'bold'}} >Mobile Application</h6>
